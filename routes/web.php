...
//        Route::post('{user}/passwordreset', 'UsersController@passwordreset')->name('passwordreset');
    ...
    Route::group(['prefix' => 'appusers'], function () {
        Route::get('{appusers}/edit', 'AppUsersController@edit')->name('appusers.edit');
//        Route::get('{appusers}/update', 'AppUsersController@update')->name('appusers.update');
        Route::get('{appusers}/delete', 'AppUsersController@destroy')->name('appusers.delete');
        Route::get('{appusers}/confirm-delete', 'AppUsersController@getModalDelete')->name('appusers.confirm-delete');
        Route::get('{appusers}/restore', 'AppUsersController@getRestore')->name('appusers.restore');
    });
    Route::resource('appusers', 'AppUsersController');
    /*routes for file*/
    Route::group(['prefix' => 'file'], function () {
        Route::post('create', 'FileController@store')->name('store');
        Route::post('createmulti', 'FileController@postFilesCreate')->name('postFilesCreate');
