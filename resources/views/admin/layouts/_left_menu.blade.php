...
-->	
    ...
    <li {!! ((Request::is('admin/appusers') || Request::is('admin/appusers/create') || Request::is('admin/blog') ||  Request::is('admin/blog/create')) || Request::is('admin/blog/*') || Request::is('admin/appusers/*') ? 'class="active"' : '') !!}>
        <a href="#">
            <i class="livicon" data-name="users" data-c="#418BCA" data-hc="#418BCA" data-size="18"
               data-loop="true"></i>
            <span class="title">App User</span>
            <span class="fa arrow"></span>
        </a>
        <ul class="sub-menu">
            <li {!! (Request::is('admin/appusers') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/appusers') }}">
                    <i class="fa fa-angle-double-right"></i>
                    App Users List
                </a>
            </li>
